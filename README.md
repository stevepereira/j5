...
j5 is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
You can start j5 locally by running:
...
Then you can interact with j5 by typing `j5 help`.

    j5> j5 help

    j5> animate me <query> - The same thing as `image me`, except adds a few
